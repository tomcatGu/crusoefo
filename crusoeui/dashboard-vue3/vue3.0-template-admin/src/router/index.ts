...
export const asyncRoutes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    children: [{
      path: '/modeler/bpmn/index',
      component: () => import('@/views/modeler/bpmn/index.vue'),
      meta: {
        title: {
          '/zh-CN': 'BPMN模型',
          '/en-US': 'BPMN Modeler'
    ...
    {
      path: 'bpmn-edit/:id',
      component: () => import('@/views/modeler/bpmn/edit/index.vue'),
      meta: {
        title: {
          '/zh-CN': '修改BPMN模型',
          '/en-US': 'Edit BPMN Modeler'
        }, icon: 'dashboard', hidden: true
      },

    },
    {
      path: 'cmmn',
      component: () => import('@/views/modeler/cmmn/index.vue'),
      meta: {
        title: {
          '/zh-CN': 'CMMN模型',
          '/en-US': 'CMMN Modeler'
